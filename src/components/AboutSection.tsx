      ...
      <div className="container">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-heading font-bold mb-8">
            Prazer, eu sou a{" "}
            <span className="text-gradient-gold italic">Raissa</span>
          </h2>

          <div className="w-32 h-32 rounded-full overflow-hidden mx-auto mb-8 border-2 border-primary/30 shadow-glow-rose">
            <img
