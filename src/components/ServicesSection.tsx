      ...
      <div className="container">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-heading font-bold mb-4">
            Escolha seu{" "}
            <span className="text-gradient-gold italic">tratamento ideal</span>
          </h2>
          <p className="text-muted-foreground font-body max-w-md mx-auto">
            Cada serviço pensado para entregar o melhor resultado possível
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {serviceGroups.map((group, i) => (
            <div
              key={i}
              className="bg-gradient-card border border-border rounded-2xl p-6 hover:border-primary/20 transition-all"
            >
